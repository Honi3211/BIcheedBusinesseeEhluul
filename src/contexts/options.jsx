...
export const haveUnder18Options = [
  { label: "Тийм", value: "Тийм", id: 1 },
  { label: "Үгүй", value: "Үгүй", id: 2 },
];
export const isBoughtHouseOptions = [
  { label: "Тийм", value: "Тийм", id: 1 },
  { label: "Үгүй", value: "Үгүй", id: 2 },
];
export const haveLendPartnerOptions = [
  { label: "Тийм", value: "Тийм", id: 1 },
  { label: "Үгүй", value: "Үгүй", id: 2 },
];

// Partner options
export const partnerIsMarriedOptions = [
  { label: "Гэрлэсэн", value: "Гэрлэсэн", id: 1 },
  { label: "Хамтран амьдрагчтай", value: "Хамтран амьдрагчтай", id: 2 },
  { label: "Ганц бие", value: "Ганц бие", id: 3 },
];
export const partnerHaveUnder18Options = [
  { label: "Тийм", value: "Тийм", id: 1 },
  { label: "Үгүй", value: "Үгүй", id: 2 },
];
export const partnerIsBoughtHouseOptions = [
  { label: "Тийм", value: "Тийм", id: 1 },
  { label: "Үгүй", value: "Үгүй", id: 2 },
];